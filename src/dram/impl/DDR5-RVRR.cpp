  ...
  private:
    void set_organization()
    {
        ...
        for (int r = 0; r < num_channels * num_ranks; r++)
        {
            ...
            register_stat(s_total_rrfm_cycles[r]).name("total_rrfm_cycles_rank" + std::to_string(r));
            register_stat(s_total_vrr_cycles[r]).name("total_vrr_cycles_rank" + std::to_string(r));
            register_stat(s_total_rvrr_cycles[r]).name("total_rvrr_cycles_rank" + std::to_string(r));
        }
    };
